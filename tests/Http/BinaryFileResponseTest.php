...
use vxPHP\Tests\Http\File\FakeFile;
...
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    {
        $response = BinaryFileResponse::create(new FilesystemFile(__DIR__.'/File/Fixtures/test.gif'), 200, ['Content-Type' => 'application/octet-stream'])->setAutoEtag();
    ...
    {
        $response = BinaryFileResponse::create(new FilesystemFile(__DIR__.'/File/Fixtures/test.gif'), 200, ['Content-Type' => 'application/octet-stream']);
    ...
    public function testRangeRequestsWithoutLastModifiedDate()
    {
        ...
        $response = BinaryFileResponse::create(new FilesystemFile(__DIR__.'/File/Fixtures/test.gif'), 200, ['Content-Type' => 'application/octet-stream'], true, null, false, false);
    ...
    {
        $response = BinaryFileResponse::create(new FilesystemFile(__DIR__.'/File/Fixtures/test.gif'), 200);

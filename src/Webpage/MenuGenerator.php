<?php
    ...
    class MenuGenerator
    {
        ...
        public function __construct(Menu|string|null $menuOrId = null, ?int $level = null, bool $forceActiveMenu = false, ?string $decorator = null, mixed $renderArgs = null)
        {
            if ($menuOrId instanceof Menu) {
                ...
                if (empty($menuOrId)) {
                    ...
                    // fall back to the menu with default id or first menu in the configured list
        ...
        private function primePathSegments(): array
        {
            ...
            // if pathSegments are empty, use the route path as fallback
        ...
        public function render(): string
        {
            ...
            // if the menu has not been prepared yet, do it now (caching avoids reparsing for submenus)
            ...
            if (!in_array($this->menu, self::$primedMenus, true)) {
                ...
                // walk the entire menu and add dynamic entries where necessary

                $this->completeMenu($this->menu);

                // walk the tree until an active entry is reached
        ...
        /**
         * walks the menu tree and clears all previously selected entries
         *
         * @param Menu $menu
         */
         ...
         * if required dynamic menus will be added
         *
         * @param Menu $m
        ...
        protected function walkMenuTree(Menu $m, array $pathSegments): ?MenuEntry
        {
            ...
            // return when matching entry in the current menu

...
/**
 * simple iterator which allows traversing the result returned by Pgsql::doPreparedQuery()
...
class PgsqlRecordsetIterator extends \ArrayIterator implements RecordsetIteratorInterface
{
    /**

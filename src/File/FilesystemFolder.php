<?php
    ...
    class FilesystemFolder
    {
        ...
        /**
         * relative path with the application assets path as root
         * @var string|null
         */
        ...
        /**
         * returns all FilesystemFile instances in the folder
         ...
         * @throws FilesystemFolderException
         */
        public function getParentFolder(bool $force = false): ?self
        {
         ...
         * returns the path to subfolder when the folder exists, undefined otherwise
         *
         * @param boolean $force
         * @return string|null
         */
         ...
         * returns a newly created FilesystemFolder object
         *
         * @param string $folderName
         * @return FilesystemFolder
         * @throws FilesystemFolderException
         */
        public function createFolder(string $folderName): self
        {
         ...
         * warning: any reference to the old instance still exists and will yield invalid results
         *
         * @param string $to
         * @return FilesystemFolder
         * @throws FilesystemFolderException
        ...
        /**
         * move folder
         * removes the instance from lookup hash
         * and returns a new instance of the new filesystemfolder
         * warning: any reference to the old instance still exists and will yield invalid results
         *

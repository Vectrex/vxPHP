...
class MimeTypeGetter {
	 ...
	 * fileinfo extension is installed and uses it. If no extension is
	 * loaded or $skipExtension is true the MIME type is determined with
	 * the custom file extension list
	 * 
	 * @param string $file the path to the File
	 ...
	 * otherwise an exception will be triggered, since no fallback is
	 * implemented
	 * 
	 * @param string $buffer
	 * @return string

<?php
    ...
    class SessionUser extends User
    {
         ...
         * @var string
         */
        public const string DEFAULT_KEY_NAME = 'user';

        /**
         * Constructor
         *
         * Additional arguments are a session key under which the user is
         * stored and a flag which marks the user as authenticated
         *
        ...
        /**
         * set or unset the authentication flag without checking any credentials
         *
         * @param boolean $authenticated

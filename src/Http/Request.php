...
class Request {
	...
	public function getPort() {
		...
		if ($this->isFromTrustedProxy()) {
			if (
				self::$trustedHeaders[self::HEADER_CLIENT_PORT] &&
			...
			if (
				self::$trustedHeaders[self::HEADER_CLIENT_PROTO] &&
	 ...
	 * Gets the user info.
	 * returns a user name
	 * and, optionally, scheme-specific information about how to gain authorization to access the server 
	 *
	 * @return string
	 */
	...
	public function getHost() {
		...
		if (
			$this->isFromTrustedProxy() &&
			self::$trustedHeaders[self::HEADER_CLIENT_HOST] &&
	 ...
	 * format is set to $default if format was not set before
	 *
	...
	/**
	 * check whether request headers indicate "no-cache"
	 * 
	 * @return bool
	 */
	...
	public function getEncodings() {
		...
		if (NULL === $this->encodings) {
			$this->encodings = array_keys(AcceptHeader::fromString($this->headers->get('Accept-Encoding'))->all());
		}
	...
	public function getAcceptableContentTypes() {
		...
		if (NULL === $this->acceptableContentTypes) {
			$this->acceptableContentTypes = array_keys(AcceptHeader::fromString($this->headers->get('Accept'))->all());
		}
